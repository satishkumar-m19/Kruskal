...
public class GenerateInputFile {
	public static void main(String[] args) throws IOException {
		...
		File file = new File("/Users/sati/Documents/input-files/inputfile.txt");
		...
		/*
		 * Use this part of code to read the input from user. Goto project
		 * settings and allow user input option before you execute. try {
		 * BufferedReader bufferRead = new BufferedReader(new
		 * InputStreamReader(System.in)); noOfLines = bufferRead.readLine();
		...
		for (int i = 1; i <= noOfLines; i++) {
			...
			System.out.println("<" + i + "," + randomNumber1 + ","
					+ randomNumber2 + ">");
			formattedline = "<" + i + "," + randomNumber1 + "," + randomNumber2
					+ ">";
